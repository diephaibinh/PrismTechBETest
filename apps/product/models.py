...
class Merchant(models.Model):
    ...
    hashtags = models.ManyToManyField("Hashtag", blank=True, related_name="merchants")
    categories = models.ManyToManyField("Category", blank=True, related_name="merchants")
    keywords = models.ManyToManyField("Keyword", blank=True, related_name="merchants")
